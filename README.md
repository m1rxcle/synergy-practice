...
Третье задание: Выполнено с помощью **Django** на **Python**

Реализован проект в котором создаем веб приложение.
Пользователи могут вводить свои имена и получать приветствие на главной странице.
Имена хранятся в базе данных **sqlite3**.
Обеспечена обработка возможных ошибок, таких как пустое поле имени при отправке формы.
Добавлены стилизацию к веб приложению.
