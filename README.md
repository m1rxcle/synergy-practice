...
Третье задание: Выполнено снова на **Html**, **Css** и **Js**

Реализован **интерактивный калькулятор**.
Создал **интерфейс**, включающий 4 кнопки два инпута и пустое окно для вывода результата.
Добавил стилизацию интерфейса.
Создали 4 функции, соответствующие математическим действиям, обозначенных в названиях кнопок.
Добавлен вывод в окошко “результат” сообщение об ошибке, если в инпуты введены не цифры.
